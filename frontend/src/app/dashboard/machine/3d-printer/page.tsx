  ...
  const onSubmit: SubmitHandler<FormInputValues> = async (data) => {
    ...
    try {
      ...
      const payload = {
        ...
        screenshotFileId: (data.screenshotFileId === "pending" ? "" : data.screenshotFileId) || "",
      };
  ...
  return (
    <div className="container p-6 space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">3D 列印機借用申請</h1>
        ...
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex justify-between items-center h-5">
                        <FormLabel>列印份數 <span className="text-red-500 ml-1">*</span></FormLabel>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex justify-between items-center h-5">
                        <FormLabel>填充度 (%) <span className="text-red-500 ml-1">*</span></FormLabel>
                        {form.formState.errors.infill && (
                          <span className="text-destructive text-xs leading-none">{form.formState.errors.infill.message}</span>
                        )}
                      </div>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex justify-between items-center h-5">
                        <FormLabel>預估耗材 (g) <span className="text-red-500 ml-1">*</span></FormLabel>
                        {form.formState.errors.estimateMaterial && (
                          <span className="text-destructive text-xs leading-none">{form.formState.errors.estimateMaterial.message}</span>
                        )}
                      </div>
                      <FormControl>
               ...
               <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>若需預約特定時段請填寫，或留空由管理員安排。</FormDescription>
                    </FormItem>
                  )}
                />
          ...
          <Card>
            <CardHeader>
               ...
               <CardDescription>請上傳 Gcode 檔案與切片軟體預覽截圖。</CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                     <div className="flex justify-between items-center mb-2">
                        <FormLabel className="text-base font-semibold">
                            切片軟體截圖 <span className="text-red-500 ml-1">*</span>
                        </FormLabel>
                    ...
                    <FormControl>
                      <FileUpload
                        ...
                        formatHint="支援格式: .jpg, .png (Max 10MB)"
                         className={form.formState.errors.screenshotFileId ? "border-red-500 bg-red-50" : ""}
                      />
                    </FormControl>
                    {field.value && (
                       <p className="text-sm text-green-600 mt-2 flex items-center">
                         <span className="mr-2">✓</span> {field.value === "pending" ? "截圖已選擇" : "截圖已上傳"}
                       </p>
                    )}
                  </FormItem>
                )}
